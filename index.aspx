<%@ Page Title="" Language="C#" MasterPageFile="~/Banken.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Le_Banc_Fiffle.WebForm1" %>
          ...
          <div class="sektion sektion-ett mobil">
             <img src="/Images/MelkerochEbbabadar.jpg" alt="2 barn badar" width="100%" height="auto" /> 
              <h2>Om JE-bank</h2>
                   ...
                   <br />fördelat på 7 200 i Norge, 9875 i Sverige och 5281 i Danmark.  
                   </p>
           </div>
